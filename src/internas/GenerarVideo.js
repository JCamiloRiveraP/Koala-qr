...
const GenerarVideo = ({ onGenerateQRCode }) => {
  ...
  const handleGenerate = async () => {
    if ((!videoURL && !videoFile) || !title || !description) {
      ...
      <div className="custom-width space-y-5 md:space-y-7 w-full relative p-4 md:p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">
            {step === 1 && "1. Proporcione los detalles del video"}
              ...
              <div className="p-4 bg-white rounded-lg shadow border border-gris-oscuro">
                ...
                >
                  <div className="flex items-center space-x-2 gap-1">
                    ...
                    <div>
                      <h4 className="font-medium">Subir o enlazar un video</h4>
                      <p className="text-sm text-gray-500 font-light">
                        Carga un archivo o proporciona la URL del video.
                      </p>
                    </div>
                  </div>
                  <FiChevronRight
