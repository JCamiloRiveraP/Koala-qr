...
const GenerarCupon = ({ onGenerateQRCode }) => {
  ...
  const handleGenerate = async () => {
    if (!couponCode || !discount || !expirationDate || !description) {
      ...
      <div className="custom-width space-y-5 md:space-y-7 w-full relative p-4 md:p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">
            {step === 1 && "1. Proporcione los detalles del cupón"}
              ...
              <div className="p-4 bg-white rounded-lg shadow border border-gris-oscuro">
                ...
                >
                  <div className="flex items-center space-x-2 gap-1">
                    ...
                    <div>
                      <h4 className="font-medium">Código del Cupón</h4>
                      <p className="text-sm text-gray-500 font-light">
                        Ingrese el código único del cupón.
                      </p>
                    </div>
                  </div>
                  <FiChevronRight
              ...
              <div className="p-4 bg-white rounded-lg shadow border border-gris-oscuro">
                ...
                >
                  <div className="flex items-center space-x-2 gap-1">
                    ...
                    <div>
                      <h4 className="font-medium">Descuento</h4>
                      <p className="text-sm text-gray-500 font-light">
                ...
                >
                  <div className="flex items-center space-x-2 gap-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 font-light">
                        Establezca la fecha de expiración del cupón.
                      </p>
                    </div>
                  </div>
                  <FiChevronRight
                ...
                >
                  <div className="flex items-center space-x-2 gap-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 font-light">
                        Proporcione una descripción del cupón.
                      </p>
                    </div>
                  </div>
                  <FiChevronRight
