...
const GenerarImagenes = ({ onGenerateQRCode }) => {
  ...
  const handleGenerate = async () => {
    if (!galleryName || !galleryDescription || images.length === 0) {
      alert("Por favor, complete todos los campos y suba al menos una imagen.");
      return;
    }
  ...
  const handleDownload = () => {
    ...
    link.href = qrCode;
    link.download = "galeria-qr-code.png";
    link.click();
  };
          ...
          <div>
            {step === 1 && (
              <div className="space-y-4">
                {/* Acordeón: Información de la galería */}
                    ...
                    <div className="flex items-center space-x-2 gap-1">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 font-light">
                          Añade un nombre y una descripción para tu galería.
                        </p>
                      </div>
                    </div>
                    <FiChevronRight
                ...
                <div className="p-4 bg-white rounded-lg shadow border border-gris-oscuro">
                  ...
                  >
                    <div className="flex items-center space-x-2 gap-1">
                      ...
                      <div>
                        <h4 className="font-medium">Subir Imágenes</h4>
                        <p className="text-sm text-gray-500 font-light">
                          Proporcione las imágenes que desea incluir.
                        </p>
                      </div>
                    </div>
                    <FiChevronRight
