...
app.use(cors());
app.use(bodyParser.json({ limit: "50mb" })); // Límite de 50MB para JSON
app.use(bodyParser.urlencoded({ extended: true, limit: "50mb" })); // Límite para datos codificados en URL
